...
import 'package:ecommerce_app/res/notification/alarm/alarm_awesome.dart';
         ...
         if (message.data['type'] != null &&
            message.data['type'] == 'alarm') {
             // Platform.isAndroid?
              ...
              log("ecommerce_app message just showed up :  ${message.notification?.toMap()}");
...
// import 'package:ecommerce_app/features/notification/domain/controller/notification_controller.dart';
// import 'package:ecommerce_app/res/notification/alarm/alarm.dart';
// import 'package:firebase_messaging/firebase_messaging.dart';
